 ...
 * Generated on Tue, 16 Aug 2022 20:03:44 GMT
 */

export const text : {header : string,emphasis : string,subdued : string,onBackground : string,body : string};
export const surface : {level0 : string,level1 : string,level2 : string,level3 : string};
export const interactiveSurface : {background : string,hover : string,active : string};
...
export const system : {textBase : string,textHover : string,textActive : string,backgroundBase : string,borderBase : string,borderHover : string,borderActive : string,borderFocused : string};
...
export const input : {backgroundBase : string,backgroundHover : string,backgroundInformation : string,textBase : string,textInformation : string,textInformationError : string,textLabel : string,textFloatingLabel : string,textFloatingLabelError : string,textPlaceholder : string,borderBase : string,borderError : string};